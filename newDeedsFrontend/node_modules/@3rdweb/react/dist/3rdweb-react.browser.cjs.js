...
const ConnectButton = ({
  ...
  const [renderBalance, setRenderBalance] = React.useState("");
  React.useEffect(() => {
    const getBalance = async () => {
      if (address) {
        const balance = await provider?.getBalance(address);
        setRenderBalance(units.formatEther(balance || 0).slice(0, 6));
      } else {
  ...
  return /*#__PURE__*/React__default["default"].createElement(react.Tooltip, {
    ...
    color: "#0098EE",
    lineHeight: "14px"
  }, renderBalance, networkMetadata && networkMetadata.symbol.length > 2 && /*#__PURE__*/React__default["default"].createElement("br", null), networkMetadata?.symbol)) : /*#__PURE__*/React__default["default"].createElement(react.Button, _extends({
    px: 6,
    borderRadius: "8px",
...
exports.ThirdwebThemeProvider = ThirdwebThemeProvider;
